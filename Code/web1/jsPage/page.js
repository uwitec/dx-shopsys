...
showPages.prototype.createHtml = function(className){ //生成html代码
	...
	if (prevPage < 1) {
		strHtml += '<span title="第一页" class="disabled">第一页</span>';
		strHtml += '<span title="上一页" class="disabled">上一页</span>';
	} else {
		strHtml += '<span title="第一页"><a href="javascript:' + this.name + '.toPage(1);">第一页</a></span>';
	...
	if (nextPage > this.pageCount) {
		...
		strHtml += '<span title="最后一页" class="disabled">最后一页</span>';
	} else {
