<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsPicManage.aspx.cs" Inherits="web1.Admin.NewsPicManage" %>
...
<body>
    ...
    <h4>&nbsp;&nbsp;
    当前栏目：<asp:HyperLink ID="hlParentLbname" runat="server">Mian新闻</asp:HyperLink> > 
    ...
    <asp:HiddenField ID="hlbid" runat="server" />
        ...
        <Columns>
            ...
            <ItemTemplate><a href="<%# Eval("pic") %>" target="_blank"><img src="<%# Eval("picSmall") %>" alt="单击放大查看" style="display:<%# (Eval("picSmall").ToString()=="")?"none":"block" %>"/></a>
            </ItemTemplate>
            </asp:TemplateField>
