<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proTypeManage.aspx.cs" Inherits="web1.Admin.proTypeManage" %>
...
<body>
    ...
    <asp:HiddenField ID="hlbid" runat="server" />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="title" HeaderText="大类名称" ItemStyle-HorizontalAlign="Left" />
