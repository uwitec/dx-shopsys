...
<body>
    ...
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabelStyle">
        ...
        <tr>
            ...
            <td width="79%">
                <asp:DropDownList ID="ddlLbid" runat="server">
                </asp:DropDownList>
        ...
        <tr>
            ...
            <td>
            <FCKeditorV2:FCKeditor ID="FCKeditor3" FormatSource="true" EnableSourceXHTML="true" runat="server" Height="150" ToolbarSet="VideoWindow"></FCKeditorV2:FCKeditor>
                <div>
                添加方法：单上面编辑器中的“源代码”按钮，进入源码编辑模式，将视频代码粘贴即可。<br />
                优酷示例代码：<textarea rows="4" style="width:400px; height:80px;"><embed src="http://player.youku.com/player.php/Type/Folder/Fid/19249423/Ob/1/sid/XNTUzMTQxNzcy/v.swf" quality="high" width="480" height="400" align="middle" allowScriptAccess="always" allowFullScreen="true" mode="transparent" type="application/x-shockwave-flash"></embed></textarea> 
                </div>
        ...
        <tr>
            ...
            <td><FCKeditorV2:FCKeditor ID="FCKeditor2" runat="server" Height="200"  ToolbarSet="Basic">
