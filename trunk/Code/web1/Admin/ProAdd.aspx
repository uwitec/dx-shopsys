<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProAdd.aspx.cs" Inherits="web1.Admin.ProAdd" %>
...
<body>
    ...
    <h4>
        &nbsp;&nbsp;<asp:Label ID="lblPname" runat="server"></asp:Label></h4>
    ...
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabelStyle">
        ...
        <tr>
            <td>
                类别：</td>
            <td>
                <asp:RadioButtonList ID="lbList" runat="server" CssClass="RadioList" RepeatDirection="Horizontal" RepeatColumns="10">
                </asp:RadioButtonList>
            </td>
        </tr>
        ...
        <tr>
            ...
            <div id="upSmallButton"><span id="spanButtonPlaceholder_small"></span></div>
                ...
                <img id="PicSmall" alt="缩略图" width="206" />
                </div>
                建议尺寸：206×277
                px</td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:CheckBoxList ID="functionList" runat="server" RepeatColumns="7" RepeatDirection="Horizontal" CssClass="RadioList">
                </asp:CheckBoxList>
            </td>
        </tr>
        <tr>
