<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IconManage.aspx.cs" Inherits="web1.Admin.IconManage" %>
...
<body>
    ...
    <h4>&nbsp;&nbsp;
    当前栏目：<asp:HyperLink ID="hlParentLbname" runat="server">功能图标管理</asp:HyperLink> > &nbsp;&nbsp;
    ...
    <asp:HiddenField ID="hlbid" runat="server" />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="title" HeaderText="排序" ItemStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="Description" HeaderText="图标描述" ItemStyle-HorizontalAlign="Left" />

            <asp:TemplateField HeaderText="图片" ItemStyle-Width="50">
            <ItemTemplate>
            <img width="34" src="<%# Eval("pic") %>" style="display:<%# (Eval("pic").ToString()=="")?"none":"block" %>"/>
    ...
    <cc2:UcfarPager ID="Pager1" runat="Server"  PageSize="20"  PagePara="Page"  PageStyle="前后缩略">
</cc2:UcfarPager>
