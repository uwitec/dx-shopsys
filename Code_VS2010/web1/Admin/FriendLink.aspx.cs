    ...
    public partial class FriendLink : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string lbid;
                    ...
                    hlParentLbname.NavigateUrl = "FriendLink.aspx?lbid=" + lbid;
                    hlbid.Value = lbid;
                    bindGv();
                }
                catch (Exception ex)
        ...
        public DataTable getNewsDt()
        {
            ...
            try
            {
                ...
                string sql = @"SELECT NewsID,Title,Pic,Href ,EditTime
...
WHERE lbid=" + lbid;
        ...
        protected void GV_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Save")
            {
                ...
                try
                {
                    txtHref = this.GV.Rows[index].Cells[2].Controls[0] as TextBox;
                }
                catch
                {
                ...
                try
                {
                    txtEditTime = this.GV.Rows[index].Cells[3].Controls[0] as TextBox;
                }
                catch
                {
                ...
                if (href == "")
                {
                    alert.ShowAndBack(Page, "请填写链接地址");
                    return;
                }
                ...
                if (NewsID.Length > 0)
                {
                    ...
                    //更新
                    string sql = "UPDATE News SET title='" + title + "',editTime='" + EditTime + "',href='"+href+"'";
                    if (pic.Length > 0)
                    {
                        sql += " ,pic='" + pic + "'";
