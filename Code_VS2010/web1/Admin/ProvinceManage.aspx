<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProvinceManage.aspx.cs" Inherits="web1.Admin.ProvinceManage" %>
...
<body>
    ...
    <h4>&nbsp;&nbsp;
    当前栏目：<asp:HyperLink ID="hlParentLbname" runat="server">省份管理</asp:HyperLink> > &nbsp;&nbsp;
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderText="省份名称" ItemStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="JianCheng" HeaderText="简称" ItemStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="OrderId" HeaderText="排序" ItemStyle-HorizontalAlign="Left" />

            <asp:HyperLinkField DataNavigateUrlFields="id,name" DataNavigateUrlFormatString="CityManage.aspx?pid={0}&p={1}" HeaderText="城市管理" Text="管理"/>
